...
public class MonstersGirlsItems {
    ...
    // -- Variables --
    public static final Item POWDER_GENESIS = register(MonstersGirlsID.POWDER_GENESIS, new EnchantedItem(new FabricItemSettings().rarity(Rarity.RARE)));

    // HAT
    public static final Item HAT_MUSHROOM_BROWN = register(MonstersGirlsID.HAT_MUSHROOM_BROWN, new ArmorItem(MonstersGirlsArmorMaterial.BROWN_MUSHROOM, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_CRIMSON = register(MonstersGirlsID.HAT_MUSHROOM_CRIMSON, new ArmorItem(MonstersGirlsArmorMaterial.CRIMSON_FUNGUS, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_CRIMSON_RARE = register(MonstersGirlsID.HAT_MUSHROOM_CRIMSON_RARE, new ArmorItem(MonstersGirlsArmorMaterial.CRIMSON_RARE_FUNGUS, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_ENDER_PUFFBALL = register(MonstersGirlsID.HAT_MUSHROOM_ENDER_PUFFBALL, new ArmorItem(MonstersGirlsArmorMaterial.ENDER_PUFFBALL, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_FLY_RED_AGARIC = register(MonstersGirlsID.HAT_MUSHROOM_FLY_RED_AGARIC, new ArmorItem(MonstersGirlsArmorMaterial.FLY_RED_AGARIC, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_FLY_YELLOW_AGARIC = register(MonstersGirlsID.HAT_MUSHROOM_FLY_YELLOW_AGARIC, new ArmorItem(MonstersGirlsArmorMaterial.FLY_YELLOW_AGARIC, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_INFERNAL = register(MonstersGirlsID.HAT_MUSHROOM_INFERNAL, new ArmorItem(MonstersGirlsArmorMaterial.INFERNAL_MUSHROOM_, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_INK_CAP = register(MonstersGirlsID.HAT_MUSHROOM_INK_CAP, new ArmorItem(MonstersGirlsArmorMaterial.INK_CAP_MUSHROOM, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_MOLTEN = register(MonstersGirlsID.HAT_MUSHROOM_MOLTEN, new ArmorItem(MonstersGirlsArmorMaterial.MOLTEN_FUNGUS, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_SOUL_WANDERER = register(MonstersGirlsID.HAT_MUSHROOM_SOUL_WANDERER, new ArmorItem(MonstersGirlsArmorMaterial.SOUL_WANDERER_FUNGUS, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_WARPED = register(MonstersGirlsID.HAT_MUSHROOM_WARPED, new ArmorItem(MonstersGirlsArmorMaterial.WARPED_FUNGUS, ArmorItem.Type.HELMET, new FabricItemSettings()));
    public static final Item HAT_MUSHROOM_WARPED_RARE = register(MonstersGirlsID.HAT_MUSHROOM_WARPED_RARE, new ArmorItem(MonstersGirlsArmorMaterial.WARPED_RARE_FUNGUS, ArmorItem.Type.HELMET, new FabricItemSettings()));
    ...
    public static final Item SPAWN_MANDRAKE_GIRL_GREEN = register(MonstersGirlsID.SPAWN_MANDRAKE_GIRL_GREEN, new SpawnItem(MonstersGirlsEntities.MANDRAKE_GIRL_GREEN, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_CRIMSON = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_CRIMSON, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_CRIMSON, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_CRIMSON_RARE = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_CRIMSON_RARE, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_CRIMSON_RARE, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_FLY_AGARIC_RED = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_FLY_AGARIC_RED, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_FLY_AGARIC, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_FLY_AGARIC_YELLOW = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_FLY_AGARIC_YELLOW, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_AMANITA_YELLOW, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_INK_CAP = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_INK_CAP, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_INK_CAP, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_WARPED = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_WARPED, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_WARPED, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_WARPED_RARE = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_WARPED_RARE, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_WARPED_RARE, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_BROWN = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_BROWN, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_BROWN, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_ENDER_PUFFBALL = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_ENDER_PUFFBALL, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_ENDER_PUFFBALL, new FabricItemSettings()));
    public static final Item SPAWN_MUSHROOM_GIRL_INFERNAL = register(MonstersGirlsID.SPAWN_MUSHROOM_GIRL_INFERNAL, new SpawnItem(MonstersGirlsEntities.MUSHROOM_GIRL_INFERNAL, new FabricItemSettings()));
    ...
    public static final Item SPAWN_WISP_GIRL_GREEN = register(MonstersGirlsID.SPAWN_WISP_GIRL_GREEN, new SpawnItem(MonstersGirlsEntities.WISP_GIRL_GREEN, new FabricItemSettings()));
    public static final Item SPAWN_WISP_GIRL_YELLOW = register(MonstersGirlsID.SPAWN_WISP_GIRL_YELLOW, new SpawnItem(MonstersGirlsEntities.WISP_GIRL_YELLOW, new FabricItemSettings()));
    ...
    public static final Item POTTED_ENDER_PUFFBALL_MUSHROOM = register(MonstersGirlsID.POTTED_ENDER_PUFFBALL_MUSHROOM, MonstersGirlsBlocks.POTTED_ENDER_PUFFBALL_MUSHROOM, false);
    public static final Item POTTED_INK_CAP_MUSHROOM = register(MonstersGirlsID.POTTED_INK_CAP_MUSHROOM, MonstersGirlsBlocks.POTTED_INK_CAP_MUSHROOM, false);
    public static final Item POTTED_MOLTEN_FUNGUS = register(MonstersGirlsID.POTTED_MOLTEN_FUNGUS, MonstersGirlsBlocks.POTTED_MOLTEN_FUNGUS, false);
    public static final Item POTTED_SOUL_WANDERER_FUNGUS = register(MonstersGirlsID.POTTED_SOUL_WANDERER_FUNGUS, MonstersGirlsBlocks.POTTED_SOUL_WANDERER_FUNGUS, false);
    ...
    private static Item register(String name, Item item) {
        ItemGroupEvents.modifyEntriesEvent(MonstersGirlsItemsGroup.DEFAULT_GROUP).register(entries -> entries.add(item));
        return Registry.register(Registries.ITEM, new Identifier(MonstersGirls.MODID, name), item);
    } // register ()

    private static Item register(String name, Block block) {
        ItemGroupEvents.modifyEntriesEvent(MonstersGirlsItemsGroup.DEFAULT_GROUP).register(entries -> entries.add(block));
        return Registry.register(Registries.ITEM, new Identifier(MonstersGirls.MODID, name), new BlockItem(block, new FabricItemSettings()));
    } // register

    private static Item register(String name, Block block, boolean isTabOn) {
        return Registry.register(Registries.ITEM, new Identifier(MonstersGirls.MODID, name), new BlockItem(block, new FabricItemSettings()));
    } // register
