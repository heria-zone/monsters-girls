...
public class MonstersGirlsEntities {
    ...
    // -- Variables --
    public static final EntityType<BeeGirlEntity> BEE_GIRL = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "bee_girl"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, BeeGirlEntity::new).dimensions(EntityDimensions.fixed(0.5F, 1F)).build());

    public static final EntityType<GourdragoraJackOLanternEntity> GOURDRAGORA_GIRL_JACK_LANTERN = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "gourdragora_girl_jack_lantern"),
    ...
    public static final EntityType<GourdragoraJackOLanternBigEntity> GOURDRAGORA_GIRL_JACK_LANTERN_BIG = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "gourdragora_girl_jack_lantern_big"),
    ...
    public static final EntityType<GourdragoraJackOLanternMiniEntity> GOURDRAGORA_GIRL_JACK_LANTERN_MINI = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "gourdragora_girl_jack_lantern_mini"),
    ...
    public static final EntityType<GourdragoraPumpkinEntity> GOURDRAGORA_GIRL_PUMPKIN = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "gourdragora_girl_pumpkin"),
    ...
    public static final EntityType<GourdragoraPumpkinBigEntity> GOURDRAGORA_GIRL_PUMPKIN_BIG = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "gourdragora_girl_pumpkin_big"),
    ...
    public static final EntityType<GourdragoraPumpkinMiniEntity> GOURDRAGORA_GIRL_PUMPKIN_MINI = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "gourdragora_girl_pumpkin_mini"),
    ...
    public static final EntityType<MandrakeBrownEntity> MANDRAKE_GIRL_BROWN = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mandrake_girl_brown"),
    ...
    public static final EntityType<MandrakeChorusEntity> MANDRAKE_GIRL_CHORUS = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mandrake_girl_chorus"),
    ...
    public static final EntityType<MandrakeGlowBerryEntity> MANDRAKE_GIRL_GLOW_BERRY = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mandrake_girl_glow_berry"),
    ...
    public static final EntityType<MandrakeGreenEntity> MANDRAKE_GIRL_GREEN = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mandrake_girl_green"),
    ...
    public static final EntityType<MushroomCrimsonEntity> MUSHROOM_GIRL_CRIMSON = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_crimson"),
    ...
    public static final EntityType<MushroomCrimsonRareEntity> MUSHROOM_GIRL_CRIMSON_RARE = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_crimson_rare"),
    ...
    public static final EntityType<MushroomInkCapEntity> MUSHROOM_GIRL_INK_CAP = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_ink_cap"),
    ...
    public static final EntityType<MushroomWarpedEntity> MUSHROOM_GIRL_WARPED = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_warped"),
    ...
    public static final EntityType<MushroomWarpedRareEntity> MUSHROOM_GIRL_WARPED_RARE = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_warped_rare"),
    ...
    public static final EntityType<MushroomFlyAgaricRedEntity> MUSHROOM_GIRL_FLY_AGARIC = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_red"),
    ...
    public static final EntityType<MushroomFlyAgaricYellowEntity> MUSHROOM_GIRL_AMANITA_YELLOW = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_yellow"),
    ...
    public static final EntityType<MushroomBrownEntity> MUSHROOM_GIRL_BROWN = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_brown"),
    ...
    public static final EntityType<MushroomEnderPuffballEntity> MUSHROOM_GIRL_ENDER_PUFFBALL = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_ender_puffball"),
    ...
    public static final EntityType<MushroomInfernalEntity> MUSHROOM_GIRL_INFERNAL = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_infernal"),
    ...
    public static final EntityType<MushroomMoltenEntity> MUSHROOM_GIRL_MOLTEN = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_molten_fungus"),
    ...
    public static final EntityType<MushroomSoulWandererEntity> MUSHROOM_GIRL_SOUL_WANDERER = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_soul_wanderer"),
    ...
    public static final EntityType<SpookPeachEntity> SPOOK_GIRL_PEACH = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "spook_girl_peach"),
    ...
    public static final EntityType<SpookTealEntity> SPOOK_GIRL_TEAL = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "spook_girl_teal"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, SpookTealEntity::new).dimensions(EntityDimensions.fixed(0.4F, 1.3F)).build());

    public static final EntityType<WispBlueEntity> WISP_GIRL_BLUE = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "wisp_girl_blue"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, WispBlueEntity::new).dimensions(EntityDimensions.fixed(0.4F, 0.8F)).build());

    public static final EntityType<WispGreenEntity> WISP_GIRL_GREEN = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "wisp_girl_green"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, WispGreenEntity::new).dimensions(EntityDimensions.fixed(0.4F, 0.8F)).build());

    public static final EntityType<WispYellowEntity> WISP_GIRL_YELLOW = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "wisp_girl_yellow"),
    ...
    public static final EntityType<MushroomSnowballEntity> MUSHROOM_GIRL_SNOWBALL = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "mushroom_girl_snowball"),
    ...
    public static final EntityType<SlimeGirlEntity> SLIME_GIRL = Registry.register(Registry.ENTITY_TYPE, new Identifier(MonstersGirls.MODID, "slime_girl"),
    ...
    public static void registerRender () {
        ...
        EntityRendererRegistry.register(MUSHROOM_GIRL_AMANITA_YELLOW, MushroomFlyAgaricYellowRenderer::new);
        ...
        EntityRendererRegistry.register(MUSHROOM_GIRL_FLY_AGARIC, MushroomFlyAgaricRedRenderer::new);
