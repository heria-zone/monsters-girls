...
public class ModBlocks {
    ...
    public static final Block ENDER_PUFFBALL_BLOCK = registerBlock("ender_puffball_block", new Block(FabricBlockSettings.of(Material.WOOD).strength(0.2F).sounds(BlockSoundGroup.WOOD)), ModItemsGroup.MONSTERS_GIRLS);
    public static final Block ENDER_PUFFBALL_STEM = registerBlock("ender_puffball_stem", new PillarBlock(FabricBlockSettings.of(Material.WOOD, MapColor.PALE_PURPLE).strength(0.2F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE)), ModItemsGroup.MONSTERS_GIRLS);
    public static final Block ENDER_PUFFBALL_PLANKS = registerBlock("ender_puffball_planks", new Block(FabricBlockSettings.of(Material.NETHER_WOOD, ENDER_COLOR).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE)), ModItemsGroup.MONSTERS_GIRLS);
    ...
    public static final Block ENDER_PUFFBALL_TRAPDOOR = registerBlock("ender_puffball_trapdoor", new TrapdoorBlock(FabricBlockSettings.of(Material.NETHER_WOOD, ENDER_COLOR).strength(3.0F).nonOpaque().sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE)), ModItemsGroup.MONSTERS_GIRLS);
    ...
    public static final Block MOLTEN_FUNGUS_PLANKS = registerBlock("molten_fungus_planks", new Block(FabricBlockSettings.of(Material.NETHER_WOOD, MOLTEN_COLOR).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE)), ModItemsGroup.MONSTERS_GIRLS);
    ...
    public static final Block MOLTEN_FUNGUS_TRAPDOOR = registerBlock("molten_fungus_trapdoor", new TrapdoorBlock(FabricBlockSettings.of(Material.NETHER_WOOD, MOLTEN_COLOR).strength(3.0F).nonOpaque().sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE)), ModItemsGroup.MONSTERS_GIRLS);
    ...
    public static final Block SOUL_WANDERER_PLANKS = registerBlock("soul_wanderer_planks", new Block(FabricBlockSettings.of(Material.NETHER_WOOD, SOUL_COLOR).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE)), ModItemsGroup.MONSTERS_GIRLS);
    ...
    public static final Block SOUL_WANDERER_TRAPDOOR = registerBlock("soul_wanderer_trapdoor", new TrapdoorBlock(FabricBlockSettings.of(Material.NETHER_WOOD, SOUL_COLOR).strength(3.0F).nonOpaque().sounds(BlockSoundGroup.WOOD).luminance(LUMINANCE)), ModItemsGroup.MONSTERS_GIRLS);
