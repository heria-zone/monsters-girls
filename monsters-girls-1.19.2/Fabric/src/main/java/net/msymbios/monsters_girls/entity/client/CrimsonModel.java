...
public class CrimsonModel extends AnimatedGeoModel<CrimsonEntity> {
    ...
    // -- Methods --
    @Override
    public Identifier getModelResource(CrimsonEntity animatable) {
        return new Identifier(MonstersGirlsMod.MODID, EntityModel.Mushroom.getName());
    } // getModelResource ()

    @Override
    public Identifier getTextureResource(CrimsonEntity animatable) {
        return animatable.getTexture();
    } // getTextureResource ()

    @Override
    public Identifier getAnimationResource(CrimsonEntity animatable) {
        return new Identifier(MonstersGirlsMod.MODID, EntityAnimator.Variant.getName());
    } // getAnimationResource ()

    @Override
    public void setLivingAnimations(CrimsonEntity animatable, Integer uniqueID, AnimationEvent event){
