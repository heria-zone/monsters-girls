...
import net.msymbios.monsters_girls.client.model.MushroomWarpedRareModel;
...
public class MushroomWarpedRareRenderer extends GeoEntityRenderer<MushroomWarpedRareEntity> {
    ...
    // -- Method --
    @Override
    public Identifier getTextureResource(MushroomWarpedRareEntity instance) { return instance.getCurrentTexture(); } // getTextureResource ()
