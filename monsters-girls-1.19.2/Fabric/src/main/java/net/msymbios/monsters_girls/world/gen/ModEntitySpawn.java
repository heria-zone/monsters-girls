...
public class ModEntitySpawn {
    ...
    public static void register() {
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.MEADOW, BiomeKeys.BIRCH_FOREST, BiomeKeys.FLOWER_FOREST)), ModEntities.MANDRAKE_GIRL_GREEN, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.MEADOW, BiomeKeys.BIRCH_FOREST, BiomeKeys.FLOWER_FOREST)), ModEntities.MANDRAKE_GIRL_BROWN, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.LUSH_CAVES)), ModEntities.MANDRAKE_GIRL_GLOW_BERRY, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.SMALL_END_ISLANDS, BiomeKeys.END_MIDLANDS, BiomeKeys.END_HIGHLANDS)), ModEntities.MANDRAKE_GIRL_CHORUS, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.MEADOW, BiomeKeys.BIRCH_FOREST, BiomeKeys.FLOWER_FOREST, BiomeKeys.TAIGA)), ModEntities.MUSHROOM_GIRL_BROWN, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.CRIMSON_FOREST)), ModEntities.MUSHROOM_GIRL_CRIMSON, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.CRIMSON_FOREST)), ModEntities.MUSHROOM_GIRL_CRIMSON_RARE, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.SMALL_END_ISLANDS, BiomeKeys.END_MIDLANDS, BiomeKeys.END_HIGHLANDS)), ModEntities.MUSHROOM_GIRL_ENDER_PUFFBALL, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.NETHER_WASTES)), ModEntities.MUSHROOM_GIRL_INFERNAL, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.PLAINS, BiomeKeys.BIRCH_FOREST)), ModEntities.MUSHROOM_GIRL_INK_CAP, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.BASALT_DELTAS)), ModEntities.MUSHROOM_GIRL_MOLTEN, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.DARK_FOREST, BiomeKeys.MUSHROOM_FIELDS, BiomeKeys.TAIGA)), ModEntities.MUSHROOM_GIRL_FLY_AGARIC, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.SOUL_SAND_VALLEY)), ModEntities.MUSHROOM_GIRL_SOUL_WANDERER, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.WARPED_FOREST)), ModEntities.MUSHROOM_GIRL_WARPED, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.WARPED_FOREST)), ModEntities.MUSHROOM_GIRL_WARPED_RARE, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.TAIGA, BiomeKeys.OLD_GROWTH_PINE_TAIGA, BiomeKeys.OLD_GROWTH_SPRUCE_TAIGA)), ModEntities.MUSHROOM_GIRL_AMANITA_YELLOW, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.FOREST)), ModEntities.SPOOK_GIRL_TEAL, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.FOREST)), ModEntities.SPOOK_GIRL_PEACH, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.SWAMP)), ModEntities.WISP_GIRL_BLUE, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.SWAMP)), ModEntities.WISP_GIRL_GREEN, 20, 1, 2);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.SWAMP)), ModEntities.WISP_GIRL_YELLOW, 20, 1, 2);
