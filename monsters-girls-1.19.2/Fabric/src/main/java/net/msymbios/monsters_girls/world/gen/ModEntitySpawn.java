...
public class ModEntitySpawn {
    ...
    public static void register() {
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.MEADOW, BiomeKeys.BIRCH_FOREST, BiomeKeys.FLOWER_FOREST)), ModEntities.MANDRAKE_GIRL_GREEN, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.MEADOW, BiomeKeys.BIRCH_FOREST, BiomeKeys.FLOWER_FOREST)), ModEntities.MANDRAKE_GIRL_BROWN, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.LUSH_CAVES)), ModEntities.MANDRAKE_GIRL_GLOW_BERRY, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.SMALL_END_ISLANDS, BiomeKeys.END_MIDLANDS, BiomeKeys.END_HIGHLANDS)), ModEntities.MANDRAKE_GIRL_CHORUS, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.MEADOW, BiomeKeys.BIRCH_FOREST, BiomeKeys.FLOWER_FOREST, BiomeKeys.TAIGA)), ModEntities.MUSHROOM_GIRL_BROWN, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.CRIMSON_FOREST)), ModEntities.MUSHROOM_GIRL_CRIMSON, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.CRIMSON_FOREST)), ModEntities.MUSHROOM_GIRL_CRIMSON_RARE, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.SMALL_END_ISLANDS, BiomeKeys.END_MIDLANDS, BiomeKeys.END_HIGHLANDS)), ModEntities.MUSHROOM_GIRL_ENDER_PUFFBALL, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.NETHER_WASTES)), ModEntities.MUSHROOM_GIRL_INFERNAL, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.PLAINS, BiomeKeys.BIRCH_FOREST)), ModEntities.MUSHROOM_GIRL_INK_CAP, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.BASALT_DELTAS)), ModEntities.MUSHROOM_GIRL_MOLTEN, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.FOREST, BiomeKeys.DARK_FOREST, BiomeKeys.MUSHROOM_FIELDS, BiomeKeys.TAIGA)), ModEntities.MUSHROOM_GIRL_FLY_AGARIC, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.SOUL_SAND_VALLEY)), ModEntities.MUSHROOM_GIRL_SOUL_WANDERER, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.WARPED_FOREST)), ModEntities.MUSHROOM_GIRL_WARPED, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.WARPED_FOREST)), ModEntities.MUSHROOM_GIRL_WARPED_RARE, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.TAIGA, BiomeKeys.OLD_GROWTH_PINE_TAIGA, BiomeKeys.OLD_GROWTH_SPRUCE_TAIGA)), ModEntities.MUSHROOM_GIRL_AMANITA_YELLOW, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.FOREST)), ModEntities.SPOOK_GIRL_TEAL, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.FOREST)), ModEntities.SPOOK_GIRL_PEACH, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.SWAMP)), ModEntities.WISP_GIRL_BLUE, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.SWAMP)), ModEntities.WISP_GIRL_GREEN, 10, 1, 1);
        ...
        registerSpawn(new ArrayList<>(List.of(BiomeKeys.DARK_FOREST, BiomeKeys.SWAMP)), ModEntities.WISP_GIRL_YELLOW, 10, 1, 1);
