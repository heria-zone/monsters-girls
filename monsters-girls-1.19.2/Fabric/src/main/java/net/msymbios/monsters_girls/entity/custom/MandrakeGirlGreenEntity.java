...
public class MandrakeGirlGreenEntity extends InternalEntity implements IAnimatable {
    ...
    // -- Constructor --
    public MandrakeGirlGreenEntity(EntityType<? extends TameableEntity> entityType, World world) {
        super(entityType, world);
    } // Constructor MandrakeGirlGreenEntity ()
