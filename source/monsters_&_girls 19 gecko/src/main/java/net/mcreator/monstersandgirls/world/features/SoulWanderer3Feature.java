...
public class SoulWanderer3Feature extends Feature<NoneFeatureConfiguration> {
	public static SoulWanderer3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SoulWanderer3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("monsters_and_girls:soul_wanderer_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("monsters_and_girls:soul_wanderer_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("monsters_and_girls", "soulwanderer3"));
		if (template == null)
			return false;
