...
public class RareWarpedJarModel extends AnimatedGeoModel<RareWarpedJarEntity> {
	@Override
	public ResourceLocation getAnimationResource(RareWarpedJarEntity entity) {
		return new ResourceLocation("monsters_and_girls", "animations/size1mushroombed.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(RareWarpedJarEntity entity) {
		return new ResourceLocation("monsters_and_girls", "geo/size1mushroombed.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(RareWarpedJarEntity entity) {
