...
public class MoltenFungus1Feature extends Feature<NoneFeatureConfiguration> {
	public static MoltenFungus1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MoltenFungus1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("monsters_and_girls:molten_fungus_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("monsters_and_girls:molten_fungus_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public MoltenFungus1Feature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(MonstersAndGirlsModBlocks.MOLTEN_FUNGUS.get());
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("monsters_and_girls", "moltenfungus1"));
		if (template == null)
			return false;
