...
public class RedMushromGalModel extends AnimatedGeoModel<RedMushromGalEntity> {
	@Override
	public ResourceLocation getAnimationResource(RedMushromGalEntity entity) {
		return new ResourceLocation("monsters_and_girls", "animations/mushroomgirl.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(RedMushromGalEntity entity) {
		return new ResourceLocation("monsters_and_girls", "geo/mushroomgirl.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(RedMushromGalEntity entity) {
		return new ResourceLocation("monsters_and_girls", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(RedMushromGalEntity animatable, int instanceId, AnimationEvent animationEvent) {
