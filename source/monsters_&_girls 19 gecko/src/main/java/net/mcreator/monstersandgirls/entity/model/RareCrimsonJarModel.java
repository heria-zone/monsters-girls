...
public class RareCrimsonJarModel extends AnimatedGeoModel<RareCrimsonJarEntity> {
	@Override
	public ResourceLocation getAnimationResource(RareCrimsonJarEntity entity) {
		return new ResourceLocation("monsters_and_girls", "animations/size1mushroombed.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(RareCrimsonJarEntity entity) {
		return new ResourceLocation("monsters_and_girls", "geo/size1mushroombed.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(RareCrimsonJarEntity entity) {
