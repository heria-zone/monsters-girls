...
public class SoulWandererGalModel extends AnimatedGeoModel<SoulWandererGalEntity> {
	@Override
	public ResourceLocation getAnimationResource(SoulWandererGalEntity entity) {
		return new ResourceLocation("monsters_and_girls", "animations/mushroomgirl.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SoulWandererGalEntity entity) {
		return new ResourceLocation("monsters_and_girls", "geo/mushroomgirl.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(SoulWandererGalEntity entity) {
		return new ResourceLocation("monsters_and_girls", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(SoulWandererGalEntity animatable, int instanceId, AnimationEvent animationEvent) {
