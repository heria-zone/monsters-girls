...
public class SoulWanderer2Feature extends Feature<NoneFeatureConfiguration> {
	public static SoulWanderer2Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SoulWanderer2Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("monsters_and_girls:soul_wanderer_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("monsters_and_girls:soul_wanderer_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SoulWanderer2Feature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(Blocks.SOUL_SOIL);
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("monsters_and_girls", "soulwanderer2"));
		if (template == null)
			return false;
