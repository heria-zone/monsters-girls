...
public class FlyAlexgaricModel extends AnimatedGeoModel<FlyAlexgaricEntity> {
	@Override
	public ResourceLocation getAnimationResource(FlyAlexgaricEntity entity) {
		return new ResourceLocation("monsters_and_girls", "animations/mushroomgirl.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(FlyAlexgaricEntity entity) {
		return new ResourceLocation("monsters_and_girls", "geo/mushroomgirl.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(FlyAlexgaricEntity entity) {
		return new ResourceLocation("monsters_and_girls", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(FlyAlexgaricEntity animatable, int instanceId, AnimationEvent animationEvent) {
