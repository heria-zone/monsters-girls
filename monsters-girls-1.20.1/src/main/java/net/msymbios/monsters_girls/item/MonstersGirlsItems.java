...
public class MonstersGirlsItems {
    ...
    public static final Item POTTED_ENDER_PUFFBALL_MUSHROOM = register(MonstersGirlsID.POTTED_ENDER_PUFFBALL_MUSHROOM, MonstersGirlsBlocks.POTTED_ENDER_PUFFBALL_MUSHROOM);
    public static final Item POTTED_INK_CAP_MUSHROOM = register(MonstersGirlsID.POTTED_INK_CAP_MUSHROOM, MonstersGirlsBlocks.POTTED_INK_CAP_MUSHROOM);
    public static final Item POTTED_MOLTEN_FUNGUS = register(MonstersGirlsID.POTTED_MOLTEN_FUNGUS, MonstersGirlsBlocks.POTTED_MOLTEN_FUNGUS);
    public static final Item POTTED_SOUL_WANDERER_FUNGUS = register(MonstersGirlsID.POTTED_SOUL_WANDERER_FUNGUS, MonstersGirlsBlocks.POTTED_SOUL_WANDERER_FUNGUS);
    ...
    public static void register() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.SPAWN_EGGS).register(MonstersGirlsItems::addItemsToSpawnEggsGroup);
    } // register ()
