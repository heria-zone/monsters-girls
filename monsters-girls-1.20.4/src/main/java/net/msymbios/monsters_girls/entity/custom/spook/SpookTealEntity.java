...
import net.msymbios.monsters_girls.entity.custom.WispEntity;
...
public class WispBlueEntity extends WispEntity {
    ...
    protected void initGoals() {
        super.initGoals();
        this.goalSelector.add(2, new TemptGoal(this, WispVariant.BLUE.getMoveSpeed(), WispVariant.BLUE.getFood(), false));
        this.goalSelector.add(4, new FollowOwnerGoal(this, WispVariant.BLUE.getMoveSpeed(), 2.0F, 12.0F, false));
        this.goalSelector.add(5, new FlyGoal(this, WispVariant.BLUE.getMoveSpeed()));
    } // initGoals ()
