...
public class SpookPeachModel extends AnimatedGeoModel<SpookPeachEntity> {
    ...
    // -- Methods --
    @Override
    public Identifier getModelLocation(SpookPeachEntity animatable) {
        return animatable.getCurrentModel();
    } // getModelLocation ()

    @Override
    public Identifier getTextureLocation(SpookPeachEntity animatable) {
        return animatable.getCurrentTexture();
    } // getTextureLocation ()

    @Override
    public Identifier getAnimationFileLocation(SpookPeachEntity animatable) {
