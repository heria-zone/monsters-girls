...
public class MushroomBrownEntity extends InternalEntity implements GeoEntity {
    ...
    public static DefaultAttributeContainer.Builder setAttributes() {
        return MobEntity.createMobAttributes()
                ...
                .add(EntityAttributes.GENERIC_FLYING_SPEED, InternalMetric.getAttribute(EntityVariant.MushroomBrown, EntityAttribute.FLYING_SPEED));
    } // setAttributes ()
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new FollowOwnerGoal(this, InternalMetric.getAttribute(EntityVariant.MushroomBrown, EntityAttribute.MOVEMENT_FOLLOW_OWNER), InternalMetric.getAttribute(EntityVariant.MushroomBrown, EntityAttribute.FOLLOW_RANGE_MAX), InternalMetric.getAttribute(EntityVariant.MushroomBrown, EntityAttribute.FOLLOW_RANGE_MIN), false));
        this.goalSelector.add(4, new MeleeAttackGoal(this, InternalMetric.getAttribute(EntityVariant.MushroomBrown, EntityAttribute.MOVEMENT_MELEE_ATTACK), false));
        ...
        this.goalSelector.add(8, new WanderAroundFarGoal(this, InternalMetric.getAttribute(EntityVariant.MushroomBrown, EntityAttribute.MOVEMENT_WANDER_AROUND)));
