...
public abstract class WispEntity extends FlyingTamableEntity implements GeoEntity {
    ...
    protected void initGoals() {
        ...
        this.targetSelector.add(2, new ActiveTargetGoal<>(this, VexEntity.class, false));
        this.targetSelector.add(2, new ActiveTargetGoal<>(this, PhantomEntity.class, false));
     ...
     */
    public static DefaultAttributeContainer createAttributes(WispVariant variant) {
