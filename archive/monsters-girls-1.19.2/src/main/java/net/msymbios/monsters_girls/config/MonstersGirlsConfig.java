...
public class MonstersGirlsConfig {
    ...
    public static void register() {
        ...
        MonstersGirls.LOGGER.debug("Registering Config Options for: " + MonstersGirls.MODID);
    } // generate ()
    ...
    private static void create() {
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.bee.girl.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.brown.movement-follow-owner", 0.6F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.brown.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.brown.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.green.movement-follow-owner", 0.6F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.green.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.green.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.glow_berry.movement-follow-owner", 0.6F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.glow_berry.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.glow_berry.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.chorus.movement-follow-owner", 0.6F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.chorus.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mandrake.chorus.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.brown.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.brown.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.brown.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.brown.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson_rare.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson_rare.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson_rare.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.crimson_rare.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ender_puffball.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ender_puffball.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ender_puffball.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ender_puffball.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.infernal.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.infernal.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.infernal.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.infernal.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ink_cap.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ink_cap.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ink_cap.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.ink_cap.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.molten.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.molten.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.molten.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.molten.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_red.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_red.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_red.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_red.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_yellow.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_yellow.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_yellow.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.fly_agaric_yellow.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.soul_wanderer.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.soul_wanderer.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.soul_wanderer.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.soul_wanderer.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped_rare.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped_rare.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped_rare.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.warped_rare.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.snowball.movement-melee-attack", 0.6F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.snowball.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.snowball.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.mushroom.snowball.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.blue.movement-melee-attack", 0.8F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.blue.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.blue.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.wisp.movement-fly-speed", 0.8F),     "Movement Speed when its flying");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.blue.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.green.movement-melee-attack", 0.8F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.green.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.green.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.green.movement-fly-speed", 0.8F),     "Movement Speed when its flying");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.green.movement-speed", 0.6F),         "Movement Speed");
        ...
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.yellow.movement-melee-attack", 0.8F),  "Movement speed when it is melee attacking");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.yellow.movement-follow-owner", 0.7F),  "Movement speed when following player");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.yellow.movement-wander-around", 0.6F), "Movement speed while it is wandering around");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.yellow.movement-fly-speed", 0.8F),     "Movement Speed when its flying");
        PROVIDER.addKeyValuePair(new Pair<>("entity.wisp.yellow.movement-speed", 0.6F),         "Movement Speed");
    ...
    private static void assign() {
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.Bee, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.bee.girl.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MandrakeBrown, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mandrake.brown.movement-follow-owner", 0.6F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mandrake.brown.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mandrake.brown.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MandrakeGreen, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mandrake.green.movement-follow-owner", 0.6F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mandrake.green.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mandrake.green.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MandrakeGlowBerry, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mandrake.glow_berry.movement-follow-owner", 0.6F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mandrake.glow_berry.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mandrake.glow_berry.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MandrakeChorus, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mandrake.chorus.movement-follow-owner", 0.6F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mandrake.chorus.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mandrake.chorus.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomBrown, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.brown.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.brown.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.brown.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.brown.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomCrimson, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.crimson.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.crimson.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.crimson.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.crimson.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomCrimsonRare, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.crimson_rare.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.crimson_rare.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.crimson_rare.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.crimson_rare.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomEnderPuffball, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.ender_puffball.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.ender_puffball.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.ender_puffball.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.ender_puffball.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomInfernal, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.infernal.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.infernal.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.infernal.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.infernal.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.FungusInkCap, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.ink_cap.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.ink_cap.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.ink_cap.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.ink_cap.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomMolten, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.molten.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.molten.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.molten.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.molten.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomFlyAgaricRed, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.fly_agaric_red.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.fly_agaric_red.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.fly_agaric_red.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.fly_agaric_red.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomFlyAgaricYellow, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.fly_agaric_yellow.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.fly_agaric_yellow.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.fly_agaric_yellow.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.fly_agaric_yellow.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomSoulWanderer, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.soul_wanderer.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.soul_wanderer.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.soul_wanderer.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.soul_wanderer.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomWarped, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.warped.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.warped.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.warped.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.warped.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomWarpedRare, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.warped_rare.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.warped_rare.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.warped_rare.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.warped_rare.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.MushroomSnowball, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.mushroom.snowball.movement-melee-attack", 0.6F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.mushroom.snowball.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.mushroom.snowball.movement-wander-around", 0.6F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.mushroom.snowball.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.WispBlue, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.wisp.blue.movement-melee-attack", 0.8F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.wisp.blue.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.wisp.blue.movement-wander-around", 0.6F));
            put(EntityAttribute.FLYING_SPEED,           CONFIG.getOrDefault("entity.wisp.blue.movement-fly-speed", 0.8F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.wisp.blue.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.WispGreen, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.wisp.green.movement-melee-attack", 0.8F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.wisp.green.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.wisp.green.movement-wander-around", 0.6F));
            put(EntityAttribute.FLYING_SPEED,           CONFIG.getOrDefault("entity.wisp.green.movement-fly-speed", 0.8F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.wisp.green.movement-speed", 0.6F));
        ...
        InternalMetric.ATTRIBUTES.put(EntityVariant.WispYellow, new HashMap<>() {{
            ...
            put(EntityAttribute.MOVEMENT_MELEE_ATTACK,  CONFIG.getOrDefault("entity.wisp.yellow.movement-melee-attack", 0.8F));
            put(EntityAttribute.MOVEMENT_FOLLOW_OWNER,  CONFIG.getOrDefault("entity.wisp.yellow.movement-follow-owner", 0.7F));
            put(EntityAttribute.MOVEMENT_WANDER_AROUND, CONFIG.getOrDefault("entity.wisp.yellow.movement-wander-around", 0.6F));
            put(EntityAttribute.FLYING_SPEED,           CONFIG.getOrDefault("entity.wisp.yellow.movement-fly-speed", 0.8F));
            put(EntityAttribute.MOVEMENT_SPEED,         CONFIG.getOrDefault("entity.wisp.yellow.movement-speed", 0.6F));
