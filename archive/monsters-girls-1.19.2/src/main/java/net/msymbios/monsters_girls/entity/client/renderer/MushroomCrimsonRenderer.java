...
import net.msymbios.monsters_girls.entity.client.model.MushroomCrimsonModel;
...
public class MushroomCrimsonRenderer extends GeoEntityRenderer<MushroomCrimsonEntity> {
    ...
    // -- Method --
    @Override
    public Identifier getTextureLocation(MushroomCrimsonEntity instance) { return instance.getCurrentTexture(); } // getTextureResource ()
